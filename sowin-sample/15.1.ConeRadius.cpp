...
int
main_15_1(int, char **argv)
{

	HWND appwin = SoWin::init("test");
	if (appwin == NULL) exit(1);
	...
	SoWinExaminerViewer* myViewer = new SoWinExaminerViewer(appwin);
	...
	delete myViewer;  //free up the resources occupied by the renderarea
